...
{
	//const std::string headerName = std::to_string(GetComponentID()) + ": Material";
	//bool keepThis = true;
	...
	//	{
	//		const std::string newTextureFile = Engine::GetWindow()->GetTextureFile();
	//		if (newTextureFile != "")
	//		{
	...
	//
	//	// Height Map
	//	textureFileText = "Height Map: ";
	//	if (mp_heightTex)
	//	{
	//		textureFileText += mp_heightTex->GetTextureFilePath();
	//	}
	//	ImGui::Text(textureFileText.c_str());
	//	if (ImGui::Button("New Height Map"))
	//	{
	//		const std::string newTextureFile = Engine::GetWindow()->GetTextureFile();
	//		if (newTextureFile != "")
	//		{
	//			SetHeightMap(newTextureFile);
	//		}
	//	}
	//	ImGui::SameLine(111.0f);
